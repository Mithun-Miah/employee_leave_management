	...
	<div class="login-wrap d-flex align-items-center flex-wrap justify-content-center">
		<div class="container">
			<div class="row align-items-center">
				...
				<!-- ********* Admin and User Login Details Start ************** -->
					<h5 class="text-center text-danger">Admin Login Details</h5>
					<hr>
					<h6 class="text-center">Email : <span>james@gmail.com</span> </h6>
					<h6 class="text-center">Password : <span>james</span> </h6>
					<hr>
					
					<h5 class="text-center text-warning">User Login Details</h5>
					<hr>
					<h6 class="text-center">Email : <span>bridget@gmail.com</span> </h6>
					<h6 class="text-center">Password : <span>james</span> </h6>
					<hr>
				<!-- ********* Admin and User Login Details End ************** -->					
